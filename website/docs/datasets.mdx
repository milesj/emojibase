...
| en/data.json      | 663.77 kB | 75.39 kB |
| en-gb/data.json   | 664.62 kB | 75.78 kB |
...
| en/compact.json      | 477.86 kB | 66.57 kB |
| en-gb/compact.json   | 478.71 kB | 66.96 kB |
...
| File                  |    Size | Gzipped |
| --------------------- | ------: | ------: |
| zh/messages.json      | 5.87 kB | 1.85 kB |
| zh-hant/messages.json | 5.93 kB | 1.85 kB |
| en/messages.json      | 6.19 kB | 1.54 kB |
| en-gb/messages.json   |  6.2 kB | 1.56 kB |
| sv/messages.json      | 6.22 kB | 1.75 kB |
| da/messages.json      | 6.23 kB | 1.74 kB |
| ms/messages.json      | 6.23 kB | 1.76 kB |
| ko/messages.json      | 6.26 kB | 1.99 kB |
| nb/messages.json      | 6.26 kB | 1.75 kB |
| et/messages.json      | 6.29 kB | 1.79 kB |
| it/messages.json      | 6.31 kB | 1.78 kB |
| nl/messages.json      | 6.32 kB | 1.77 kB |
| pl/messages.json      | 6.32 kB | 1.92 kB |
| de/messages.json      | 6.35 kB | 1.85 kB |
| fi/messages.json      | 6.35 kB | 1.83 kB |
| pt/messages.json      | 6.41 kB | 1.84 kB |
| es-mx/messages.json   | 6.45 kB | 1.85 kB |
| es/messages.json      | 6.45 kB | 1.85 kB |
| ja/messages.json      | 6.45 kB | 2.13 kB |
| hu/messages.json      | 6.48 kB | 1.92 kB |
| fr/messages.json      | 6.49 kB | 1.86 kB |
| lt/messages.json      | 6.51 kB |  1.9 kB |
| ru/messages.json      | 7.45 kB | 2.24 kB |
| uk/messages.json      |  7.5 kB | 2.29 kB |
| th/messages.json      | 8.63 kB | 2.34 kB |
