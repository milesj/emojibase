...
```ts
import { fetchFromCDN, fetchEmojism fetchShortcodes } from 'emojibase';
...
| File                                | Size     | Gzipped  |
| ----------------------------------- | -------- | -------- |
| en/shortcodes/github.json           | 38.82 KB | 13.76 KB |
| zh-hant/shortcodes/cldr-native.json | 52.9 KB  | 16.91 KB |
| zh/shortcodes/cldr-native.json      | 55.58 KB | 17.36 KB |
| zh-hant/shortcodes/cldr.json        | 56.78 KB | 14.96 KB |
| ja/shortcodes/cldr.json             | 57.82 KB | 16.07 KB |
...
| ja/shortcodes/cldr-native.json      | 64.44 KB | 18.21 KB |
...
| uk/shortcodes/cldr.json             | 69.88 KB | 18.99 KB |
| ru/shortcodes/cldr-native.json      | 84.3 KB  | 19.75 KB |
| uk/shortcodes/cldr-native.json      | 98.34 KB | 21.37 KB |
| th/shortcodes/cldr-native.json      | 98.56 KB | 20.07 KB |
