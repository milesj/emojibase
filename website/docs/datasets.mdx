...
- `group` (`number`) - The categorical group the emoji belongs to, ranging from `0` (smileys) to `7`
  (flags). Uncategorized emojis will use `-1`.
...
| en/shortcodes/iamcal.json           | 40.08 KB | 13.31 KB |
| en/shortcodes/emojibase.json        | 41.97 KB | 13.89 KB |
...
| th/shortcodes/cldr.json             | 59.83 KB | 17.03 KB |
